...
/**
 * Vite configuration for building the mobile-navbar-component-plugin frontend bundle.
 *
 ...
 * 4. Uses shared node_modules from root frontend directory
 */
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      name: 'MobileNavbarComponentPlugin',
